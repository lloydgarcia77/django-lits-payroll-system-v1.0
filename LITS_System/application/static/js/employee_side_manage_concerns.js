$(document).ready(function () {   
    ...
    let table =  $('#tblConcerns').DataTable({
        'columnDefs': [ {
    ...
    $("#newConcern").on("click", function(e){
        e.preventDefault();
    ...
    $("#modal-default").on("submit", ".create-concern-form", function(e){
        e.preventDefault();
        let form = $(this);
    ...
    $("#tblConcerns").on('click', ".btn-edit", function(e){
        e.preventDefault();
    ...
    $("#modal-default").on("submit",".edit-concern-form", function(e){
        e.preventDefault();
        let form = $(this); 
        ...
        $.ajax({
            ...
            success: (data) => {
                if(data.form_is_valid){  
                    ...
                    $('#tblConcerns').dataTable().fnUpdate(row_data,row,undefined,false);
                    //alert(row_data[2]);
                }else{
    ...
    $("#tblConcerns").on('click', ".btn-view", function(e){
        e.preventDefault();
    ...
    $("#tblConcerns").on('click', ".btn-delete", function(e){
        e.preventDefault(); 
        let url = $(this).attr("data-url");
        let row = $(this).closest('tr'); 
    ...
    $("#modal-default").on("submit",".delete-concern-form", function(e){
        e.preventDefault();
        let form = $(this); 
        let row = $("#modal-default").data('tr');
